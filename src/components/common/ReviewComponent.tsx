                    ...
                    <Flex className="tw-min-w-120 tw-h-fit" gap="middle">
                        <Flex vertical>
                            <p className="tw-text-7xl tw-text-orange-600 tw-font-black">
                                {props.data?.average||0}<span className="tw-text-2xl tw-font-light">/5</span>
                            </p>
                        ...
                        <Flex gap="small" vertical className="tw-flex-1">
                            <Progress percent={props.data?.fiveStar} strokeColor="orange" format={(percent) => `${percent} %`} />
                            <Progress
                            ...
                            />
                            <Progress percent={props.data?.threeStar} strokeColor="orange" format={(percent) => `${percent} %`} />
