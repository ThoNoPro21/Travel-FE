...
const FooterComponent = (props: Props) => {
    return (
        <Footer className="tw-relative tw-p-0 tw-z-0">
            ...
            <div className="tw-relative tw-w-full tw-h-55 lg:tw-h-100 tw-bg-[url('/images/bg.jpg')] tw-bg-cover tw-bg-center -tw-z-100 ">
            </div>
            <Flex className="tw-absolute tw-top-0 tw-w-full tw-h-55 lg:tw-h-100 ">
